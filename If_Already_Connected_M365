...
function Ensure-ExchangeOnlineConnection {
    ...
    throw "No active Exchange Online session was found. Run Connect-ExchangeOnline first in this same PowerShell window, then run this script without opening a new window."
}
